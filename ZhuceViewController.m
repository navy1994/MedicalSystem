...
- (UITableViewCell*) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
	...
	switch (indexPath.section)
	{
        case 0:
		    ...
		    {
			    case 0:
				     _nameTextField = [[MedTextFiled alloc]initWithArray:self.right1 andRow:indexPath.row];
				     _nameTextField.delegate = self;
				     [cell.contentView addSubview:_nameTextField];
				     break;
			    case 1:
				     _pswTextField = [[MedTextFiled alloc]initWithArray:self.right1 andRow:indexPath.row];
				     _pswTextField.delegate = self;
				    [_pswTextField setSecureTextEntry:YES];
				    [cell.contentView addSubview:_pswTextField];
				    break;
				case 2:
				     _pswTextField1 = [[MedTextFiled alloc]initWithArray:self.right1 andRow:indexPath.row];
		...
		break;
			...
			{
				case 0:
					_safeQuestionTf = [[MedTextFiled alloc]initWithArray:self.right2 andRow:indexPath.row];
					_safeQuestionTf.delegate = self;
					[cell.contentView addSubview:_safeQuestionTf];
					break;
				case 1:
					_safeResultTf = [[MedTextFiled alloc]initWithArray:self.right2 andRow:indexPath.row];
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField{
	if (_nameTextField==textField || _pswTextField==textField || _pswTextField1==textField ||_safeResultTf==textField || _safeQuestionTf==textField) {
